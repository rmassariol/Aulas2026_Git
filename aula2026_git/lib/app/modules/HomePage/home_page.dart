      ...
      child: Column(
        ...
        children: [
          ...
          ElevatedButton(
            ...
            // Texto exibido no botão
            child: const Text('Cadastro de Clientes BD'),
          ),
          const SizedBox(height: 12),
          ElevatedButton(
            // Função executada quando o botão é pressionado
            onPressed: () {
              ...
              Navigator.push(
                ...
                MaterialPageRoute(
                  // builder cria a nova página
                  builder: (_) => UsuariosApiSimplesPage(),
                ),
              );
            },
